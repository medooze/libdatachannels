#ifndef DATACHANNELS_EXTRA_CRC32C_H
#define DATACHANNELS_EXTRA_CRC32C_H
...
/*************************************************************/
#define DC_CRC32C(c,d) (c=(c>>8)^dc_crc_c[(c^(d))&0xFF])

static uint32_t  dc_crc_c[256] =
{
